...
def parse_args():
    parser = argparse.ArgumentParser('Models_about_result可视化')
    ...
    parser.add_argument('--ckpts', type=str, default='E:\ProgramCheck\Point-MAGE\experiments\pretrain-mage\cfgs\Pretrain-add-pos\ckpt-epoch-275.pth', help='ckpts')
...
def main(args):
    ...
    '''LOG'''
    args = parse_args()
    logger = logging.getLogger("Models_about_result可视化")
