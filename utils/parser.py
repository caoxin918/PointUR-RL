...
def get_args():
    ...
    # some args
    parser.add_argument('--exp_name', type = str, default='After_Finetune_vis', help = 'experiment name')
    parser.add_argument('--loss', type=str, default='cd1', help='loss name')
    parser.add_argument('--start_ckpts', type = str, default=None, help = 'reload used ckpt path')
    #ckpts的
    parser.add_argument('--ckpts', type = str, default='fig/Finetune_Last_ckpt-best.pth', help = 'test used ckpt path')
    parser.add_argument('--val_freq', type = int, default=1, help = 'test freq')
    parser.add_argument('--Rec', type=bool, default=False, help='test freq')
    parser.add_argument('--vis_modelNet40', type=bool, default=False, help='test freq')
    parser.add_argument('--vis_modelNet40_Pretrain', type=bool, default=True, help='test freq')
    parser.add_argument(
        '--vote',
        action='store_true',
        default=False,
